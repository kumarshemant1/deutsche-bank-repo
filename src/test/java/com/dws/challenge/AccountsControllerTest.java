...
class AccountsControllerTest {
  ...
  @InjectMocks
  AccountsController accountsControllerMock;
  ...
  public void transferMoneySuccessTest() throws InsufficientFundException {
	  ...
	  Mockito.when(accountsServiceMock.transferMoney("993344", "110022", amount)).thenReturn(finalResponse);
	  
	  String result = accountsControllerMock.transferMoney(dto);
	  
	  assertNotNull(result);
	  assertThat(result).contains("Funds transferred successfully");	
  }
}
